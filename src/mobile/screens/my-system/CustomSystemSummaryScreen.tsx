...
const styles = StyleSheet.create({
  ...
  title: { flex: 1, color: '#10213A', fontSize: 21, fontWeight: '900', textAlign: 'center' },
  subtitle: { color: '#64748B', fontSize: 12.5, fontWeight: '700', textAlign: 'center', marginBottom: 16 },
  ...
  costSub: { color: '#64748B', fontSize: 10.5, lineHeight: 14, fontWeight: '700', marginTop: 6 },
  ...
  warningText: { color: '#6F540B', fontSize: 11.5, lineHeight: 16, fontWeight: '700', marginTop: 4 },
  ...
  componentDetail: { color: '#64748B', fontSize: 11.5, lineHeight: 15, fontWeight: '700', marginTop: 4 },
  ...
  editButtonText: { color: '#10213A', fontSize: 12.5, fontWeight: '900' },
  ...
  breakdownLabel: { flex: 1, color: '#64748B', fontSize: 12.5, lineHeight: 17, fontWeight: '700' },
  breakdownValue: { color: '#10213A', fontSize: 12.5, fontWeight: '900' },
  ...
  totalLabel: { flex: 1, color: '#10213A', fontSize: 13.5, fontWeight: '900' },
