...
const styles = StyleSheet.create({
  ...
  title: { flex: 1, color: '#10213A', fontSize: 20, fontWeight: '900', textAlign: 'center' },
  subtitle: { color: '#64748B', fontSize: 13, fontWeight: '600', textAlign: 'center', marginBottom: 16 },
