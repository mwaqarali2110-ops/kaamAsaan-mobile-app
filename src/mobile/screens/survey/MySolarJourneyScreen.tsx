...
const styles = StyleSheet.create({
  ...
  cancelledText: { color: '#7A2E2E', fontSize: 12, fontWeight: '700', lineHeight: 17 },
  ...
  cancelTitle: { color: "#10213A", fontSize: 20, fontWeight: "900" },
  cancelMessage: {
    marginTop: 8,
    color: "#64748B",
    fontSize: 13,
  ...
  reasonText: { flex: 1, color: "#334155", fontSize: 13, fontWeight: "700" },
  ...
  keepButtonText: { color: "#10213A", fontSize: 13, fontWeight: "900" },
  confirmCancelButton: {
    flex: 1,
    minHeight: 48,
    flexDirection: "row",
