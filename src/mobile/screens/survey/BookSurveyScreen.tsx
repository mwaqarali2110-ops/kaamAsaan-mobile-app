...
export const BookSurveyScreen = ({ navigation }: any) => {
  ...
  return (
    <SafeAreaView style={styles.shell} edges={['top']}>
      ...
      <ScrollView style={styles.scroll} contentContainerStyle={[styles.content, { paddingBottom: 176 + safeBottom }]} showsVerticalScrollIndicator={false}>
        ...
        <Pressable style={[styles.dateField, dateError && styles.inputError]} onPress={openCalendar} accessibilityRole="button">
          ...
          <Text style={[styles.dateFieldText, !selectedDate && styles.datePlaceholder]} numberOfLines={1}>
            {selectedDate ? formatDisplayDate(selectedDate) : 'Select survey date'}
          </Text>
      ...
      <Pressable style={[styles.chatButton, { bottom: 92 + safeBottom }]} accessibilityLabel="WhatsApp help">
        ...
        <Pressable style={styles.modalBackdrop} onPress={closeCalendar}>
          <Pressable style={[styles.calendarSheet, { paddingBottom: Math.max(18, insets.bottom + 12) }]}>
            <View style={styles.calendarHeader}>
              <Pressable style={styles.calendarNavButton} onPress={() => moveCalendarMonth(-1)} accessibilityRole="button">
            ...
            <View style={styles.calendarGrid}>
              {calendarDays.map((day) => {
                ...
                return (
                  <Pressable
                    key={dayKey}
                    style={[styles.calendarDay, selected && styles.calendarDaySelected, todayDate && !selected && styles.calendarDayToday]}
            ...
            <View style={styles.calendarActions}>
              ...
              <Pressable style={styles.calendarConfirm} onPress={confirmCalendarDate}>
