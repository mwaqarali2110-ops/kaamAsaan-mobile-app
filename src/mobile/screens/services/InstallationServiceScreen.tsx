...
const styles = StyleSheet.create({
  ...
  screenTitle: { color: '#111827', fontSize: 20, lineHeight: 24, fontWeight: '900', letterSpacing: -0.35 },
  screenSubtitle: { marginTop: 0, color: '#656A73', fontSize: 13, lineHeight: 16, fontWeight: '600' },
  scroll: { flex: 1 },
