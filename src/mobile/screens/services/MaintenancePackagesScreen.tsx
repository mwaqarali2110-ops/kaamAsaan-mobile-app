    ...
    <SafeAreaView style={styles.shell} edges={["top"]}>
      ...
      <ScrollView
        ...
        contentContainerStyle={[
          styles.content,
          { paddingBottom: 124 + safeBottom },
        ]}
        showsVerticalScrollIndicator={false}
      >
        <Text style={styles.intro}>
          Select a package based on your system's needs. All visits include a
          certified KaamAsaan technician.
        </Text>
                ...
                <View style={styles.features}>
                  {pkg.features.map((feature) => (
                    <View key={feature} style={styles.featureRow}>
                      <Check
                        color={pkg.id === "complete" ? "#16A34A" : "#4A6F9B"}
                        size={12}
                        strokeWidth={2.5}
                      />
