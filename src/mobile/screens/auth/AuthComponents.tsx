...
const styles = StyleSheet.create({
  ...
  title: { color: '#10213A', fontSize: 24, fontWeight: '900', letterSpacing: -0.7 },
  subtitle: { marginTop: 6, marginBottom: 18, color: '#64748B', fontSize: 13, lineHeight: 18, fontWeight: '600' },
